...
echo Production Kanban System - User Manual v2.0 > "%DEPLOY_DIR%\README.txt"
echo. >> "%DEPLOY_DIR%\README.txt"
echo Quick Start: >> "%DEPLOY_DIR%\README.txt"
echo 1. Double-click start.bat >> "%DEPLOY_DIR%\README.txt"
echo 2. Or double-click index.html >> "%DEPLOY_DIR%\README.txt"
echo. >> "%DEPLOY_DIR%\README.txt"
echo System Requirements: >> "%DEPLOY_DIR%\README.txt"
echo - Windows 7 SP1 or higher >> "%DEPLOY_DIR%\README.txt"
echo - Chrome 58+ or Edge 79+ (recommended) >> "%DEPLOY_DIR%\README.txt"
...
echo - Local data storage >> "%DEPLOY_DIR%\README.txt"
echo - Master assignment >> "%DEPLOY_DIR%\README.txt"
echo - Gantt chart visualization >> "%DEPLOY_DIR%\README.txt"
echo. >> "%DEPLOY_DIR%\README.txt"
echo Important Notes: >> "%DEPLOY_DIR%\README.txt"
echo 1. Data is stored locally in browser >> "%DEPLOY_DIR%\README.txt"
echo 2. Regular backup recommended >> "%DEPLOY_DIR%\README.txt"
echo 3. Portable - can copy to any location >> "%DEPLOY_DIR%\README.txt"
echo. >> "%DEPLOY_DIR%\README.txt"
echo Version: v2.0.0 >> "%DEPLOY_DIR%\README.txt"
